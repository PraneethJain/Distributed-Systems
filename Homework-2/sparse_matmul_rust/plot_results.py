...
def main():
    ...
    avg_df = df.groupby(['matrix_size', 'processor_count'])[['execution_time_seconds', 'total_time_seconds']].mean().reset_index()
    ...
    time_p1 = avg_df[avg_df['processor_count'] == 1].set_index('matrix_size')['execution_time_seconds']
    ...
    sns.lineplot(data=time_df, x='processor_count', y='seconds', hue='matrix_size', style='time_type', marker='o', palette='viridis')
    ...
    sns.lineplot(data=avg_df, x='processor_count', y='speedup', hue='matrix_size', marker='o', palette='viridis')
    ...
    sns.lineplot(data=avg_df, x='processor_count', y='efficiency', hue='matrix_size', marker='o', palette='viridis')
    ...
    avg_df['overhead_seconds'] = avg_df['total_time_seconds'] - avg_df['execution_time_seconds']
    plt.figure(figsize=(10, 6))
    sns.lineplot(data=avg_df, x='processor_count', y='overhead_seconds', hue='matrix_size', marker='o', palette='viridis')
